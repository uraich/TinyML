# SimpleAccelerometer.py: a port of SimpleAccelerometer.ino
...
accSamplingRate = lsm6ds3.acc_odr
print("Accelerometer sampling rate: " + lsm6ds3.acc_odr_txt(accSamplingRate))
...
while True:
    while not lsm6ds3.acc_data_available:
        ...
        sleep_ms(10)
    acceleration = lsm6ds3.acc
    print("{:4.2f}\t{:4.2f}\t{:4.2f}".format(acceleration[0],acceleration[1],acceleration[2]))
    sleep_ms(10)
