...
flags.DEFINE_string("model_path", "/tmp/lstm_trained_model/mnist_lstm.tflite",
                    "the trained model path.")
flags.DEFINE_string("img_path", "/tmp/samples/sample0.png",
