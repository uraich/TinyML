...
try:
	...
	#         reset=15)
        ...
        # uncomment for the FreeNove ESP32S3-WROOM
...
pin = machine.Pin(4)      # connected GPIO 48 on ESP32S3-WROOM
neopixel = NeoPixel(pin,n) # there is a single neopixel on the ESP32S3-WROOM
# switch it off
clearPixel()
