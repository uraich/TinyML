...
import asyncio
import aioble                 # pyright: ignore[reportMissingImports]
import bluetooth              # pyright: ignore[reportMissingImports]
import struct
import time
import sys
from micropython import const  # pyright: ignore[reportMissingImports]
from machine import Pin, Timer # pyright: ignore[reportMissingImports]
...
try:
    from hw_esp32_s3_fh4r2 import * # pyright: ignore[reportMissingImports]
except:
...
class BLE_led():
    ...
    def __init__(self):
        self.state = False
        self.led = NeoPixel(Pin(NEOPIXEL),NO_OF_NEOPIXELS)  # pyright: ignore[reportUndefinedVariable]
    ...
    def on(self):
        ...
        self.led[0] = (0,0,INTENSITY)                        # pyright: ignore[reportUndefinedVariable]
        self.led.write()
        self.state = True
