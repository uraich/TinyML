...
class LSM6DS3(object):
    ...
    def acc_full_scale_value (self,full_scale_string):
        full_scale_value = full_scale_string.split(' ')
        value = int(full_scale_value[0])
        return value
    ...
    def gyro_full_scale_value(self,full_scale_string):
        return self.acc_full_scale_value(full_scale_string)
    ...
    def fifo_acc_dec_factor_value(self,dec_factor_string):
        return int(dec_factor_string)
    ...
    def fifo_gyro_dec_factor_value(self,dec_factor_string):
        return int(dec_factor_string)
    ...
    def fifo_odr_value(self,odr_string):
        return self.acc_odr_value(odr_string)
