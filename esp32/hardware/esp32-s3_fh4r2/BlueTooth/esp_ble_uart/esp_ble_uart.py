...
class Bleuart:
    def __init__(self, name, UUID_UART, UUID_TX, UUID_RX, _rxbuf=100):
    # def __init__(self,name="ESP32UART",_rxbuf=100):
    ...
    def _irq(self, event, data):
        ...
        if event == _IRQ_CENTRAL_CONNECT:
            ...
            if conn_handle in self._connections and value_handle == self._rx_handle:
                ...
                print("Message received from central: ",self._rx_buffer)
                if self._handler:
                    self._handler()
    ...
    def write(self, data):
        if len(self._connections) == 0:
            print("Not connected yet, cannot send data")
    ...
    def close(self):
        if (len(self._connections)):
            ...
            print("No connection open yet, nothing to be closed")
        for conn_handle in self._connections:
