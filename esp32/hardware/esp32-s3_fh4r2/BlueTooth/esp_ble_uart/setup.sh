...
echo "Setting esp32-s3_fh4r2 for BLE use"
dirs="$(ampy ls)"
echo $dirs
...
echo ""
echo "Uploading hardware definition file hw_esp32_s3_fh4r2.py"
ampy put ../../hw_esp32_s3_fh4r2.py /lib/hw_esp32_s3_fh4r2.py
echo "Uploading esp_ble_uart.py"
ampy put esp_ble_uart.py /lib/esp_ble_uart.py
