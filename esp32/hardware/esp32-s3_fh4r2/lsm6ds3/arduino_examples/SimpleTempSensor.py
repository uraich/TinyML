# SimpleTempSensor.py: a port of SimpleTempSensor.ino from the Arduino_LSM6DS3
# library examples to MicroPython
# Author: U. Raich
...
print("Temperature sensor sample rate: 52 Hz")
print("Temperature reading in °C")
while True:
    while not lsm6ds3.temperature_data_available:
        # print("no temperature data yet")
        sleep_ms(10)
    print("{:4.2f}".format(lsm6ds3.temperature))
    sleep_ms(10)
