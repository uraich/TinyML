...
def flashLightOn():
        neopPixel[0] = (NEOPIXEL_INTENSITY,NEOPIXEL_INTENSITY,NEOPIXEL_INTENSITY)
        neoPixel.write()
...
# initialize the flash-light LED, it is a ws2812 connected to GPIO 48
flash_light = NeoPixel(Pin(NEOPIXEL_PIN),1)
# switch it off
flashLightOff()
